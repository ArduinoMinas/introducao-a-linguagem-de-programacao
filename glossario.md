...
Bascom é uma plataforma de desenvolvimento para Microcontroladores, em especial AVR ( o mesmo usado no Arduino UNO) que permite desenvolvermos na linguagem Basic e surpreendentemente gerar um bom resultado para microcontroladores.
...
Simula é considerada a primeira linguagem de programação orientada a objetos, e seu nome sugere isso. Simula foi designada para simulações.
