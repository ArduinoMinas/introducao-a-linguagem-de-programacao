...
este será capaz de armazenar uma string com até 400 399 caracteres, já que o ultimo espaço do vetor deverá conter um \0 (null) para indicar o fim da string.
...
Os números fracionados e números usados em engenhária como os de ponto flutuantes, são representados especialmente no C/C++ e temos 3 tipos, porém somente veremos dois deles `float` e `double`
...
---
Atualizado: 09/07/2016 - 20:20 | Revisado: {{ file.mtime }} | Compilado: {{ gitbook.time }}
